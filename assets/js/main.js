(function($){
    ...
    document.querySelectorAll('.single-service').forEach(function(card) {
        serviceObserver.observe(card);
    });

    // cursor-tracking radial glow — all card types
    document.querySelectorAll('.single-service, .single-blog, .timeline-content-career, .single-work').forEach(function(card) {
